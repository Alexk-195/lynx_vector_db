...
- [ ] Modify main.cpp so that index type can be provided on command line
- [ ] Analyze why results with Flat index (brute force) implementation differ from results with HNSW index.
- [ ] Strip down Makefile to functionality of building lib and executables. Remove unit test build. 
